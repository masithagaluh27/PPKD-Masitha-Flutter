        ...
        children: [
          ...
          const Center(
            child: Padding(
              ...
              child: Text('Masitha',style: TextStyle(fontSize: 26,fontWeight: FontWeight.bold,color: Colors.black87,),
              ),
            ),
          ),
          ...
          const Padding(
            ...
            child: Text(
              'Masitha adalah seorang profesional di bidang teknologi yang '
              'berfokus pada pengembangan aplikasi mobile. Suka berbagi ilmu dan membangun solusi kreatif.',
